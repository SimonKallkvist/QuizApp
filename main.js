...
function selectAnswer(e) {
  ...
  if (
    ...
    console.log(answerChoices.firstChild.innerHTML.includes("checkbox"));
    console.log(selected.classList.contains("choosen"));
    // let choosenChecks = Array.from(answerChoices.children).forEach((child) => {
    //   console.log(child.children.classList.contains("choosen"));
    // });
    // console.log(choosenChecks);
  }
  // Adding the choosen btn

  // -_-
  // console.log(answerChoices.children.checked);
  // let checkArray = Array.from(answerChoices.children).forEach(child.checked);
  // console.log(checkArray);
  // console.log(answerChoices.firstChild.innerHTML.includes("checkbox"));
  // Disable all the other boxes when one is selected
